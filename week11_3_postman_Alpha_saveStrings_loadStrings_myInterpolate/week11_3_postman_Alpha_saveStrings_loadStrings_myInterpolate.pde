// week11_3_postman_Alpha_saveStrings_loadStrings_myInterpolate
//修改自 week10_6_postman_angle_ID_saveStrings_loadStrings
...
void keyPressed(){
  ...
  if(key=='r'){ // replay, 照著之前按 's' 存檔的 lines 重播一次 
    ...
    //  float alpha = (frameCount%30)/30.0; // 介於 0.0~0.1中間的值
